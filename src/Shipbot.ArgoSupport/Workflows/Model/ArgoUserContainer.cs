...
namespace AutoDeploy.ArgoSupport.Workflows.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArgoUserContainer :  IEquatable<ArgoUserContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoUserContainer" /> class.
        /// </summary>
        [JsonConstructor]
        protected ArgoUserContainer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoUserContainer" /> class.
        /// </summary>
        ...
        /// <param name="mirrorVolumeMounts">MirrorVolumeMounts will mount the same volumes specified in the main container to the container (including artifacts), at the same mountPaths. This enables dind daemon to partially see the same filesystem as the main container in order to use features such as docker volume binding.</param>
        ...
        public ArgoUserContainer(List<string> args = default(List<string>), List<string> command = default(List<string>), List<k8s.Models.V1EnvVar> env = default(List<k8s.Models.V1EnvVar>), List<k8s.Models.V1EnvFromSource> envFrom = default(List<k8s.Models.V1EnvFromSource>), string image = default(string), string imagePullPolicy = default(string), k8s.Models.V1Lifecycle lifecycle = default(k8s.Models.V1Lifecycle), k8s.Models.V1Probe livenessProbe = default(k8s.Models.V1Probe), bool? mirrorVolumeMounts = default(bool?), string name = default(string), List<k8s.Models.V1ContainerPort> ports = default(List<k8s.Models.V1ContainerPort>), k8s.Models.V1Probe readinessProbe = default(k8s.Models.V1Probe), k8s.Models.V1ResourceRequirements resources = default(k8s.Models.V1ResourceRequirements), k8s.Models.V1SecurityContext securityContext = default(k8s.Models.V1SecurityContext), bool? stdin = default(bool?), bool? stdinOnce = default(bool?), string terminationMessagePath = default(string), string terminationMessagePolicy = default(string), bool? tty = default(bool?), List<k8s.Models.V1VolumeDevice> volumeDevices = default(List<k8s.Models.V1VolumeDevice>), List<k8s.Models.V1VolumeMount> volumeMounts = default(List<k8s.Models.V1VolumeMount>), string workingDir = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ArgoUserContainer and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>MirrorVolumeMounts will mount the same volumes specified in the main container to the container (including artifacts), at the same mountPaths. This enables dind daemon to partially see the same filesystem as the main container in order to use features such as docker volume binding</value>
        [DataMember(Name="mirrorVolumeMounts", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArgoUserContainer {\n");
            ...
            sb.Append("  MirrorVolumeMounts: ").Append(MirrorVolumeMounts).Append("\n");
        ...
        {
            return this.Equals(input as ArgoUserContainer);
        }

        /// <summary>
        /// Returns true if ArgoUserContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of ArgoUserContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArgoUserContainer input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MirrorVolumeMounts == input.MirrorVolumeMounts ||
                    (this.MirrorVolumeMounts != null &&
                    this.MirrorVolumeMounts.Equals(input.MirrorVolumeMounts))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MirrorVolumeMounts != null)
                    hashCode = hashCode * 59 + this.MirrorVolumeMounts.GetHashCode();
                if (this.Name != null)
