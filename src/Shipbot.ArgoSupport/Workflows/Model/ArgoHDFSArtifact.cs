...
namespace AutoDeploy.ArgoSupport.Workflows.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArgoHDFSArtifact :  IEquatable<ArgoHDFSArtifact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoHDFSArtifact" /> class.
        /// </summary>
        [JsonConstructor]
        protected ArgoHDFSArtifact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoHDFSArtifact" /> class.
        /// </summary>
        /// <param name="addresses">Addresses is accessible addresses of HDFS name nodes (required).</param>
        /// <param name="force">Force copies a file forcibly even if it exists (default: false).</param>
        ...
        public ArgoHDFSArtifact(List<string> addresses = default(List<string>), bool? force = default(bool?), string hdfsUser = default(string), k8s.Models.V1SecretKeySelector krbCCacheSecret = default(k8s.Models.V1SecretKeySelector), k8s.Models.V1ConfigMapKeySelector krbConfigConfigMap = default(k8s.Models.V1ConfigMapKeySelector), k8s.Models.V1SecretKeySelector krbKeytabSecret = default(k8s.Models.V1SecretKeySelector), string krbRealm = default(string), string krbServicePrincipalName = default(string), string krbUsername = default(string), string path = default(string))
        {
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for ArgoHDFSArtifact and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        /// </summary>
        /// <value>Force copies a file forcibly even if it exists (default: false)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArgoHDFSArtifact {\n");
        ...
        {
            return this.Equals(input as ArgoHDFSArtifact);
        }

        /// <summary>
        /// Returns true if ArgoHDFSArtifact instances are equal
        /// </summary>
        /// <param name="input">Instance of ArgoHDFSArtifact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArgoHDFSArtifact input)
        {
            if (input == null)
                return false;
