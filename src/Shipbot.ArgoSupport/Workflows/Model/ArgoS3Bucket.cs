...
namespace AutoDeploy.ArgoSupport.Workflows.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArgoS3Bucket :  IEquatable<ArgoS3Bucket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoS3Bucket" /> class.
        /// </summary>
        [JsonConstructor]
        protected ArgoS3Bucket() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgoS3Bucket" /> class.
        /// </summary>
        ...
        public ArgoS3Bucket(k8s.Models.V1SecretKeySelector accessKeySecret = default(k8s.Models.V1SecretKeySelector), string bucket = default(string), string endpoint = default(string), bool? insecure = default(bool?), string region = default(string), k8s.Models.V1SecretKeySelector secretKeySecret = default(k8s.Models.V1SecretKeySelector))
        {
            // to ensure "accessKeySecret" is required (not null)
            if (accessKeySecret == null)
            {
                throw new InvalidDataException("accessKeySecret is a required property for ArgoS3Bucket and cannot be null");
            }
            else
            {
            ...
            if (bucket == null)
            {
                throw new InvalidDataException("bucket is a required property for ArgoS3Bucket and cannot be null");
            }
            else
            {
                this.Bucket = bucket;
            ...
            if (endpoint == null)
            {
                throw new InvalidDataException("endpoint is a required property for ArgoS3Bucket and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("secretKeySecret is a required property for ArgoS3Bucket and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ArgoS3Bucket);
        }

        /// <summary>
        /// Returns true if ArgoS3Bucket instances are equal
        /// </summary>
        /// <param name="input">Instance of ArgoS3Bucket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArgoS3Bucket input)
        {
            if (input == null)
                return false;
