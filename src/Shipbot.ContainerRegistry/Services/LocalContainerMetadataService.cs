...
{
    public class LocalContainerMetadataService : ILocalContainerMetadataService
    {
        ...
        public LocalContainerMetadataService(
    ...
    public interface ILocalContainerMetadataService
    {
